...
class CelebrityModelResultsent extends JModel{
	...
	public function &getData(){
		// Load the data
		if (empty( $this->_data )) {
			$query = 'SELECT * FROM `#__celebrity_result_sent` WHERE `id` = '.$this->_id;
...
// mcm code 
		...
		$data['result_id'] = JRequest::getVar('result_id', '', 'post', 'int');
		$data['sent_type_id'] = JRequest::getVar('sent_type_id', '', 'post', 'int');
// mcm code 
