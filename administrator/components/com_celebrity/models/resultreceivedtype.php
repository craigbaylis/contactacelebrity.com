 ...
 */
class CelebrityModelResultreceivedtype extends JModel{
	/**
	...
	public function &getData(){
		// Load the data
		if (empty( $this->_data )) {
			$query = 'SELECT * FROM `#__celebrity_result_received_type` WHERE `id` = '.$this->_id;
...
// mcm code 
		...
		$data['ordering'] = JRequest::getVar('ordering', '', 'post', 'int');
