...
<div id="editcell">
	...
	<th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
		<?php echo JHTML::_('grid.sort', JText::_( 'Quality' ), 'quality', $this->lists['order_Dir'], $this->lists['order']); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
	...
	for ($i=0, $n=count( $this->rows ); $i < $n; $i++)	{
		...
		$link = JRoute::_( 'index.php?option=com_celebrity&controller=resultqualitylist&task=edit&cid[]='. $row->id);
		?>
	...
	<td class="jcb_fieldDiv jcb_fieldValue">
		<a href="<?php echo $link; ?>"><?php echo $row->quality; ?></a>
	</td>
	<td class="jcb_fieldDiv jcb_fieldValue">
...
<input type="hidden" name="controller" value="resultqualitylist" />
