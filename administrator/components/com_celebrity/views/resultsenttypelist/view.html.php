 ...
 */
class CelebrityViewResultsenttypelist extends JView
{
	/**
	 * Resultsenttypelist view display method
	 * @return void
	 **/
	function display($tpl = null){
		...
		// draw menu
		JToolBarHelper::title(   JText::_( 'Result Sent Types' ), 'generic.png' );
        ...
        JSubMenuHelper::addEntry(JText::_('Sent Types'),'index.php?option=com_celebrity&view=resultsenttypelist',true);        
