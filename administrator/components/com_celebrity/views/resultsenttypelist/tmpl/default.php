...
<div id="editcell">
	...
	<th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
		<?php echo JHTML::_('grid.sort', JText::_( 'Label' ), 'label', $this->lists['order_Dir'], $this->lists['order']); ?>
	</th>
    <th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
	...
	for ($i=0, $n=count( $this->rows ); $i < $n; $i++)	{
		...
		$link = JRoute::_( 'index.php?option=com_celebrity&controller=resultsenttypelist&task=edit&cid[]='. $row->id);
		?>
...
<input type="hidden" name="controller" value="resultsenttypelist" />
