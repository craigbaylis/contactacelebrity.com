...
{
	/**
	 * Receivedtypelist view display method
	 * @return void
	 **/
	function display($tpl = null){
		...
		// draw menu
		JToolBarHelper::title(   JText::_( 'Result Received Types' ), 'generic.png' );
        ...
        JSubMenuHelper::addEntry(JText::_('Received Types'),'index.php?option=com_celebrity&view=receivedtypelist',true);
