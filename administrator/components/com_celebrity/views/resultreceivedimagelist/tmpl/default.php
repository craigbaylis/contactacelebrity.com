...
<div id="editcell">
    ...
    <th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
        <?php echo JHTML::_('grid.sort', JText::_( 'Result Id' ), 'result_id', $this->lists['order_Dir'], $this->lists['order']); ?>
    </th>    
	<th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
		<?php echo JHTML::_('grid.sort', JText::_( 'Title' ), 'title', $this->lists['order_Dir'], $this->lists['order']); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
		<?php echo JHTML::_('grid.sort', JText::_( 'Caption' ), 'caption', $this->lists['order_Dir'], $this->lists['order']); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
		<?php echo JHTML::_('grid.sort', JText::_( 'File Name' ), 'file_name', $this->lists['order_Dir'], $this->lists['order']); ?>
	</th>
    <th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
        <?php echo JHTML::_('grid.sort', JText::_( 'File Ext' ), 'file_ext', $this->lists['order_Dir'], $this->lists['order']); ?>
    </th>    
	<th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
	...
	for ($i=0, $n=count( $this->rows ); $i < $n; $i++)	{
		...
		$link = JRoute::_( 'index.php?option=com_celebrity&controller=resultreceivedimagelist&task=edit&cid[]='. $row->id);
		?>
...
<input type="hidden" name="controller" value="resultreceivedimagelist" />
