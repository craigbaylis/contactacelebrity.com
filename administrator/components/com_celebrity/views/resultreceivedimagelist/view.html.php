 ...
 */
class CelebrityViewResultreceivedimagelist extends JView
{
	/**
	 * Resultreceivedimagelist view display method
	 * @return void
	 **/
	function display($tpl = null){
		...
		// draw menu
		JToolBarHelper::title(   JText::_( 'Scanned Results Received' ), 'generic.png' );
        ...
        JSubMenuHelper::addEntry(JText::_('Images'),'index.php?option=com_celebrity&view=resultreceivedimagelist',true);
        JSubMenuHelper::addEntry(JText::_('Quality Types'),'index.php?option=com_celebrity&view=resultqualitylist');
