 ...
 */
class CelebrityViewResultlist extends JView
{
	/**
	 * Resultlist view display method
	 * @return void
	 **/
	function display($tpl = null){
		...
		// draw menu
		JToolBarHelper::title(   JText::_( 'Results Management' ), 'generic.png' );
        ...
        JSubMenuHelper::addEntry(JText::_('Results'),'index.php?option=com_celebrity&view=resultlist',true);
