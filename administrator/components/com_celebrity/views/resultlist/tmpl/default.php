...
<div id="editcell">
	...
	<th class="jcb_fieldDiv jcb_fieldLabel" width="5%"><?php $numCols++; ?>
	...
	<th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
		<?php echo JHTML::_('grid.sort', JText::_( 'Date Sent' ), 'date_sent', $this->lists['order_Dir'], $this->lists['order']); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
		<?php echo JHTML::_('grid.sort', JText::_( 'Received Type Id' ), 'received_type_id', $this->lists['order_Dir'], $this->lists['order']); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
		<?php echo JHTML::_('grid.sort', JText::_( 'Date Received' ), 'date_received', $this->lists['order_Dir'], $this->lists['order']); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
		<?php echo JHTML::_('grid.sort', JText::_( 'Address Id' ), 'address_id', $this->lists['order_Dir'], $this->lists['order']); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
		<?php echo JHTML::_('grid.sort', JText::_( 'Created By Id' ), 'created_by_id', $this->lists['order_Dir'], $this->lists['order']); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
		<?php echo JHTML::_('grid.sort', JText::_( 'Date Created' ), 'date_created', $this->lists['order_Dir'], $this->lists['order']); ?>
	</th>
			...
			<?php endif; ?>
            <?php if(isset($this->rows[0]->displayed)): ?>
            <th class="jcb_fieldDiv jcb_fieldLabel"><?php $numCols++; ?>
                <?php echo JHTML::_('grid.sort', JText::_( 'Displayed' ), 'displayed', $this->lists['order_Dir'], $this->lists['order']); ?>
            </th>
            <?php endif; ?>            
		</tr>
	</thead>
	...
	for ($i=0, $n=count( $this->rows ); $i < $n; $i++)	{
		...
		$link = JRoute::_( 'index.php?option=com_celebrity&controller=resultlist&task=edit&cid[]='. $row->id);
		?>
	...
	<td class="jcb_fieldDiv jcb_fieldValue">
		<a href="<?php echo $link; ?>"><?php echo $row->received_type_id; ?></a>
	</td>
	<td class="jcb_fieldDiv jcb_fieldValue">
...
<input type="hidden" name="controller" value="resultlist" />
