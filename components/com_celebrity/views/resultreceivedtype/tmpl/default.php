...
$data = $this->data;
$link = JRoute::_( "index.php?option=com_celebrity&view=resultreceivedtype&id={$data->id}" );
?>
<div>
	...
	<div class="jcb_fieldDiv">
		<span class="jcb_fieldLabel"><?php echo JText::_( 'TYPE' ); ?></span>
		<span class="jcb_fieldValue"><?php echo $data->type; ?></span>
	</div>
	<div class="jcb_fieldDiv">
