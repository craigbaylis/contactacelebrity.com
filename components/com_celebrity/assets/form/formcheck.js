...
var FormCheck = new Class({
	...
	*/
	manageError : function(el, method) {
		...
		if ((!isValid && el.validation.contains('required')) || (el.value && !isValid) || (!isValid && el.validation.contains('%almostOne'))) {
	...
	*/
	validate : function(el) {
		...
		if ((!opts.validateDisabled && el.get('disabled')) || (!el.validation.contains('required') && !el.value && !el.validation.contains('%almostOne')))
			return true;
